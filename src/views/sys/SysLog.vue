  ...
  <div>
    ...
    <div>
      <el-table :data="SysLogs" style="width: 100%" stripe>
        ...
        <el-table-column prop="requestTime" label="请求时间" fixed width="400">
        </el-table-column>
        <el-table-column prop="requestURL" label="请求地址" fixed width="200">
        </el-table-column>
        <el-table-column prop="requestInfos" label="请求操作信息" width="300">
        </el-table-column>
  ...
  methods: {
    ...
    initSysLog() {
      ...
      this.getRequest(url).then(resp => {
        if (resp) {
          this.SysLogs = resp.data.reverse();
