  ...
  <div>
    ...
    <div style="margin-top: 10px">
      <el-table :data="salaries" border stripe>
        ...
        <el-table-column width="70" prop="basisSalary" label="基本工资"></el-table-column>
        ...
        <el-table-column label="养老金" align="center">
          <el-table-column width="70" prop="socialPer" label="比率"></el-table-column>
          <el-table-column width="70" prop="socialBase" label="基数"></el-table-column>
        </el-table-column>
...
export default {
  ...
  methods: {
    showEditSalaryView(data) {
      ...
      this.salary.basisSalary = data.basisSalary;
      this.salary.trafficSalary = data.trafficSalary;
      this.salary.lunchSalary = data.lunchSalary;
      this.salary.bonus = data.bonus;
      this.salary.socialPer = data.socialPer;
      this.salary.socialBase = data.socialBase;
